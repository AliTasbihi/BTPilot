...
{
    public class BldBlkCollapseUIElement : BasicBuildingBlock
    {
        ...
        public BldBlkCollapseUIElement()
        {
        ...
        //todo:ایدتون جذاب بود که اومدید از دلیگت های برای ترنسفر دیتا استفاده کردید
