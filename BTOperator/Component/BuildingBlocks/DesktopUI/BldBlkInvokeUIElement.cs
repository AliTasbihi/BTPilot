...
{
    public class BldBlkInvokeUIElement : BasicBuildingBlock
    {
        ...
        private void AddMethod()
        {
            ...
            combo.Items.Add("Double Click");
            combo.Items.Add("Invoke");
            combo.SelectedText = "Invoke";
            Children.Add(combo);
